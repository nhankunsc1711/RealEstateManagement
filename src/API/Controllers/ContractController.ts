...
export default class ContractController {
    ...
    createContract = async (req: Request<CreateContractRequest, any, any>,res: Response) => {
        try {
    ...
    getAllContractForEmployee = async (req: Request<FindAllContractRequest, any, any>,res: Response) => {
        try {
            const employeeId: string = (req as any).user?.userId;
            const result = await this.contractService.getAllContract({employeeId: employeeId});
    ...
    getAllContract= async (req: Request<FindAllContractRequest, any, any>,res: Response) => {
        try {
    ...
    updateContract = async (req: Request<UpdateContractRequest, any, any>, res: Response) => {
        try {
